...
sudo cp /files_proftpd/proftpd.conf /etc/proftpd/proftpd.conf
sudo cp /files_proftpd/tls.conf /etc/proftpd/tls.conf
sudo cp /files_proftpd/modules.conf /etc/proftpd/modules.conf
